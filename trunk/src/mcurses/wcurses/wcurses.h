...
int wcurses_clear_region(wcurses_t *wc, SMALL_RECT *region0);
int wcurses_print(wcurses_t *wc, char *str);
int wcurses_get_attr(wcurses_t *wc, int *attr);
int wcurses_set_attr(wcurses_t *wc, int attr);
...
int wcurses_delch(wcurses_t *wc, COORD *xy);
int wcurses_inch(wcurses_t *wc, COORD *xy, TCHAR *ch);
